    ...
    <div className={styles.course}>
      ...
      >
        <g filter="url(#filter0_d_16_477)">
          ...
          <g clip-path="url(#clip0_16_477)">
            ...
            />
            <path
              d="M61.0157 38.1017H63.6824V35.4351H61.0157C60.2559 35.4376 59.5054 35.6034 58.8153 35.9214C58.1252 36.2393 57.5114 36.7019 57.0157 37.2777C56.52 36.7019 55.9062 36.2393 55.2161 35.9214C54.526 35.6034 53.7755 35.4376 53.0157 35.4351H51.6824C48.5009 35.4386 45.4507 36.704 43.201 38.9537C40.9513 41.2033 39.6859 44.2535 39.6824 47.4351V55.4351C39.6859 58.6166 40.9513 61.6668 43.201 63.9164C45.4507 66.1661 48.5009 67.4315 51.6824 67.4351H53.0157C53.7755 67.4325 54.526 67.2667 55.2161 66.9487C55.9062 66.6308 56.52 66.1683 57.0157 65.5924C57.5114 66.1683 58.1252 66.6308 58.8153 66.9487C59.5054 67.2667 60.2559 67.4325 61.0157 67.4351H63.6824V64.7684H61.0157C60.3087 64.7677 59.6308 64.4865 59.1309 63.9866C58.6309 63.4866 58.3497 62.8088 58.349 62.1017V40.7684C58.3497 40.0614 58.6309 39.3835 59.1309 38.8836C59.6308 38.3836 60.3087 38.1024 61.0157 38.1017ZM53.0157 64.7684H51.6824C49.4403 64.7644 47.2745 63.954 45.5805 62.4852C43.8865 61.0164 42.7774 58.9873 42.4557 56.7684H45.0157V54.1017H42.349V48.7684H46.349C47.4096 48.7673 48.4264 48.3456 49.1763 47.5956C49.9262 46.8457 50.348 45.8289 50.349 44.7684V42.1017H47.6824V44.7684C47.6824 45.122 47.5419 45.4612 47.2918 45.7112C47.0418 45.9612 46.7027 46.1017 46.349 46.1017H42.4557C42.7774 43.8828 43.8865 41.8537 45.5805 40.3849C47.2745 38.9161 49.4403 38.1057 51.6824 38.1017H53.0157C53.7227 38.1024 54.4006 38.3836 54.9005 38.8836C55.4005 39.3835 55.6817 40.0614 55.6824 40.7684V46.1017H53.0157V48.7684H55.6824V54.1017H53.0157C51.9552 54.1028 50.9384 54.5246 50.1884 55.2745C49.4385 56.0244 49.0168 57.0412 49.0157 58.1017V60.7684H51.6824V58.1017C51.6824 57.7481 51.8228 57.409 52.0729 57.1589C52.3229 56.9089 52.6621 56.7684 53.0157 56.7684H55.6824V62.1017C55.6817 62.8088 55.4005 63.4866 54.9005 63.9866C54.4006 64.4865 53.7227 64.7677 53.0157 64.7684Z"
              fill="#0F1014"
            />
          </g>
        </g>
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_16_477"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_dropShadow_16_477"
              result="shape"
            />
          </filter>
          <clipPath id="clip0_16_477">
            <rect
              ...
              height="34"
              fill="white"
              transform="translate(39.6824 33.4351)"
            />
          </clipPath>
        </defs>
      </svg>
      ...
      <div className={styles.course__characteristics}>
        ...
        <div className={styles.course__characteristics_rating}>
          ...
          >
            <path
              d="M15.1749 0.494873L18.6038 10.9085H29.6999L20.723 17.3444L24.1518 27.758L15.1749 21.3221L6.198 27.758L9.62688 17.3444L0.649953 10.9085H11.746L15.1749 0.494873Z"
              fill="#0F1014"
            />
          </svg>
        </div>
